...
accents center by ink on slanted nuclei; rule thickness is KaTeX
parity 40 for every kind (fraction/radical/over/underline), not the
STIX file truth (68), matching the engine's pinned 0.04em weights.
Taller delimiter variants and kerning corrections stay unwired in v1.
